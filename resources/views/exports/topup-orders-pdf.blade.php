...
<head>
    <meta charset="utf-8">
    <title>Laporan Pesanan Top Up - Diks Store</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header h1 { color: #9b59b6; font-size: 20px; margin-bottom: 5px; }
        ...
        table th { background: #9b59b6; color: white; }
        ...
        .summary { background: #f3e5f5; border: 1px solid #9b59b6; padding: 10px; margin-top: 10px; }
...
<body>
    <div class="header">
        <h1>DIKS STORE</h1>
        <p>Laporan Pesanan Top Up Game</p>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 12%;">User ID Game</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ number_format($order->topup->amount ?? 0) }} {{ $order->topup->currency_name ?? '' }}</td>
                <td>{{ $order->game_id ?? '-' }}</td>
            ...
            @empty
            <tr><td colspan="9" style="text-align:center;">Tidak ada data pesanan</td></tr>
            @endforelse
        </tbody>
    </table>
